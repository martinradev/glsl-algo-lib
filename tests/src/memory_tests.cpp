...
TEST_F(MemoryTest, SetBufferToZero)
{
    ...
    glsl_memory_set_to_zero(&ctx, inputOutputBuffer, n, 1);
...
TEST_F(MemoryTest, SetBufferToZeroMultipleElementsPerThread)
{
    ...
    glsl_memory_set_to_zero(&ctx, inputOutputBuffer, n, 4);
...
TEST_F(MemoryTest, CopyBuffer)
{
    ...
    glsl_copy_memory(&ctx, inputBuffer, outputBuffer, n, 1);
...
TEST_F(MemoryTest, CopyBufferMultipleElementsPerThread)
{
    ...
    glsl_copy_memory(&ctx, inputBuffer, outputBuffer, n, 16);
